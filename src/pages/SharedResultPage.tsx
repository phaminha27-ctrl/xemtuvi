...
import { Heart, Briefcase, DollarSign, Activity, Home, Sparkles } from "lucide-react";
...
const SharedResultPage = () => {
  ...
  const type = searchParams.get("type"); // "face" or "tarot"
    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 min-h-screen px-4 sm:px-6 md:px-8 py-6 sm:py-8 font-sans">
        <div className="max-w-xs sm:max-w-sm md:max-w-lg mx-auto">
          {type === "face" ? renderFaceResult() : renderTarotResult()}
